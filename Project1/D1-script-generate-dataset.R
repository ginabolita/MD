...
dataset <- read.csv("/home/alex/Documents/FIB/6e_quadrimestre/MD/LAB/hotel_booking.csv")
...
# Save the generated 5000 rows dataset into a CSV file
write.csv(dataset, "hotel_booking_5000_rows.csv", row.names = FALSE)
